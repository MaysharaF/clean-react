...
import { InvalidCredentialError } from '@/domain/erros'
...
describe('Login Component', () => {
  ...
  test('should start with inital state ', () => {
    ...
    // email status
    simulateStaturForField(sut, 'email', validationError)
    // password status
    simulateStaturForField(sut, 'password', validationError)
  })
  ...
  test('Should show valid email state if Validation succeeds', () => {
    const { sut } = makeSut()
    populateEmailField(sut)
    simulateStaturForField(sut, 'email')
  })

  test('Should show valid password state if Validation succeeds', () => {
    const { sut } = makeSut()
    populatePasswordField(sut)
    simulateStaturForField(sut, 'password')
  })
